    ...
    public partial class Habitaciones : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                int TipoHabitacion = int.Parse(cboxTipoHabitacion.Text);
                string Costo = cl_Habitaciones.MtdCostoHabitacion();
                ...
                try
                {
                    cd_Habitaciones.MtdAgregarHabitaciones(Numero, Ubicacion, TipoHabitacion, Costo, Estado, FechaAuditoria, UsuarioAuditoria);
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (FilaSeleccionada.Index == dataGridView1.Rows.Count - 1)
            {
                MessageBox.Show("Seleccione una fila con datos", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            else
            {
                txtCodigoHabitacion.Text = dataGridView1.SelectedCells[0].Value.ToString();
                txtNumero.Text = dataGridView1.SelectedCells[1].Value.ToString();
                txtUbicacion.Text = dataGridView1.SelectedCells[2].Value.ToString();
                cboxTipoHabitacion.Text = dataGridView1.SelectedCells[3].Value.ToString();
                lblCosto.Text = dataGridView1.SelectedCells[4].Value.ToString();
                cboxEstado.Text = dataGridView1.SelectedCells[5].Value.ToString();
                txtUsuarioAuditoria.Text = dataGridView1.SelectedCells[6].Value.ToString();
                lblFechaAuditoria.Text = dataGridView1.SelectedCells[7].Value.ToString();
            }
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                try
                {
                    cd_Habitaciones.MtdActualizarHabitaciones(Numero, Ubicacion, TipoHabitacion, Costo, Estado, FechaAuditoria, UsuarioAuditoria);
                    MessageBox.Show("Datos agregados correctamente", "Correcto", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    MtdConsultarHabitaciones();
                    MtdLimpiarCampos();
                }
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            {
                int CodigoProveedor = int.Parse(txtCodigoHabitacion.Text);
